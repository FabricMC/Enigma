...
public enum InfoType
{
	...
	FieldRefInfo( 9, 2 )
	{
		...
		public boolean subIndicesAreValid( ConstInfoAccessor entry, ConstPoolEditor pool )
		{
			...
			return classEntry != null && classEntry.getTag() == ClassInfo.getTag()
				&& nameAndTypeEntry != null && nameAndTypeEntry.getTag() == NameAndTypeInfo.getTag();
		}
	},
	...
	MethodHandleInfo( 15, 3 )
	{
		...
		public boolean subIndicesAreValid( ConstInfoAccessor entry, ConstPoolEditor pool )
		{
			...
			return typeEntry != null && typeEntry.getTag() == Utf8Info.getTag()
				&& methodRefEntry != null && methodRefEntry.getTag() == MethodRefInfo.getTag();
		}
	},
	MethodTypeInfo( 16, 1 )
	{
	...
	InvokeDynamicInfo( 18, 2 )
	{
		...
		public boolean subIndicesAreValid( ConstInfoAccessor entry, ConstPoolEditor pool )
		{
			...
			ConstInfoAccessor nameAndTypeEntry = pool.getItem( accessor.getNameAndTypeIndex() );
			return bootstrapEntry != null && bootstrapEntry.getTag() == Utf8Info.getTag()
				&& nameAndTypeEntry != null && nameAndTypeEntry.getTag() == NameAndTypeInfo.getTag();
		}
	};
